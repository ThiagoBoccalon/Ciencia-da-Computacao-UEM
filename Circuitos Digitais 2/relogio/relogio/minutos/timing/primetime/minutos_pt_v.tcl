...
read_verilog  minutos.vo
current_design minutos
link
...
set_load -pin_load 10 [get_ports { dez[0] } ]
set_load -pin_load 10 [get_ports { dez[1] } ]
set_load -pin_load 10 [get_ports { dez[2] } ]
set_load -pin_load 10 [get_ports { dez[3] } ]
...
set_load -pin_load 10 [get_ports { un[0] } ]
set_load -pin_load 10 [get_ports { un[1] } ]
set_load -pin_load 10 [get_ports { un[2] } ]
set_load -pin_load 10 [get_ports { un[3] } ]
