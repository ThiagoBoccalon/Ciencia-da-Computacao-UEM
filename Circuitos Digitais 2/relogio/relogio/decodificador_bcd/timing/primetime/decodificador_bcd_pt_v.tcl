...
read_verilog  decodificador_bcd.vo
current_design decodificador_bcd
link
...
read_sdf decodificador_bcd_v.sdo
...
set_load -pin_load 10 [get_ports { display[0] } ]
set_load -pin_load 10 [get_ports { display[1] } ]
set_load -pin_load 10 [get_ports { display[2] } ]
set_load -pin_load 10 [get_ports { display[3] } ]
set_load -pin_load 10 [get_ports { display[4] } ]
set_load -pin_load 10 [get_ports { display[5] } ]
set_load -pin_load 10 [get_ports { display[6] } ]
