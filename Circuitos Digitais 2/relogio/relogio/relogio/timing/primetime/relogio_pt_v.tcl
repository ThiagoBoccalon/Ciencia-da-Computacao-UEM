...
set_load -pin_load 10 [get_ports { change1 } ]
set_load -pin_load 10 [get_ports { change2 } ]
set_load -pin_load 10 [get_ports { dez_hora[0] } ]
set_load -pin_load 10 [get_ports { dez_hora[1] } ]
set_load -pin_load 10 [get_ports { dez_hora[2] } ]
set_load -pin_load 10 [get_ports { dez_hora[3] } ]
...
set_load -pin_load 10 [get_ports { dez_seg[0] } ]
set_load -pin_load 10 [get_ports { dez_seg[1] } ]
set_load -pin_load 10 [get_ports { dez_seg[2] } ]
set_load -pin_load 10 [get_ports { dez_seg[3] } ]
set_load -pin_load 10 [get_ports { un_hora[0] } ]
set_load -pin_load 10 [get_ports { un_hora[1] } ]
set_load -pin_load 10 [get_ports { un_hora[2] } ]
set_load -pin_load 10 [get_ports { un_hora[3] } ]
set_load -pin_load 10 [get_ports { un_min[0] } ]
set_load -pin_load 10 [get_ports { un_min[1] } ]
set_load -pin_load 10 [get_ports { un_min[2] } ]
set_load -pin_load 10 [get_ports { un_min[3] } ]
set_load -pin_load 10 [get_ports { un_seg[0] } ]
set_load -pin_load 10 [get_ports { un_seg[1] } ]
set_load -pin_load 10 [get_ports { un_seg[2] } ]
set_load -pin_load 10 [get_ports { un_seg[3] } ]
