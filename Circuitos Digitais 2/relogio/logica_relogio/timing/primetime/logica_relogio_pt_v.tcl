...
read_verilog  logica_relogio.vo
current_design logica_relogio
link
...
set_load -pin_load 10 [get_ports { s1[0] } ]
set_load -pin_load 10 [get_ports { s1[1] } ]
set_load -pin_load 10 [get_ports { s1[2] } ]
set_load -pin_load 10 [get_ports { s1[3] } ]
set_load -pin_load 10 [get_ports { s2[0] } ]
set_load -pin_load 10 [get_ports { s2[1] } ]
set_load -pin_load 10 [get_ports { s2[2] } ]
set_load -pin_load 10 [get_ports { s2[3] } ]
set_load -pin_load 10 [get_ports { s3[0] } ]
set_load -pin_load 10 [get_ports { s3[1] } ]
set_load -pin_load 10 [get_ports { s3[2] } ]
set_load -pin_load 10 [get_ports { s3[3] } ]
set_load -pin_load 10 [get_ports { s4[0] } ]
set_load -pin_load 10 [get_ports { s4[1] } ]
set_load -pin_load 10 [get_ports { s4[2] } ]
set_load -pin_load 10 [get_ports { s4[3] } ]
set_load -pin_load 10 [get_ports { s5[0] } ]
set_load -pin_load 10 [get_ports { s5[1] } ]
set_load -pin_load 10 [get_ports { s5[2] } ]
set_load -pin_load 10 [get_ports { s5[3] } ]
set_load -pin_load 10 [get_ports { s6[0] } ]
set_load -pin_load 10 [get_ports { s6[1] } ]
set_load -pin_load 10 [get_ports { s6[2] } ]
set_load -pin_load 10 [get_ports { s6[3] } ]
