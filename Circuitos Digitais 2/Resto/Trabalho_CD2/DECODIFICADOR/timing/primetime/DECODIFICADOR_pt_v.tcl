...
read_verilog  DECODIFICADOR.vo
current_design DECODIFICADOR
link
...
set_load -pin_load 10 [get_ports { S_PC0 } ]
set_load -pin_load 10 [get_ports { S_PC1 } ]
set_load -pin_load 10 [get_ports { S_PC2 } ]
set_load -pin_load 10 [get_ports { S_PC3 } ]
set_load -pin_load 10 [get_ports { S_PC4 } ]
set_load -pin_load 10 [get_ports { S_PC5 } ]
set_load -pin_load 10 [get_ports { S_UL0 } ]
set_load -pin_load 10 [get_ports { S_UL1 } ]
