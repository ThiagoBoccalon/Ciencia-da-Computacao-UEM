...
read_verilog  PORTAS_LOGICAS.vo
current_design PORTAS_LOGICAS
link
...
set_load -pin_load 10 [get_ports { S1 } ]
set_load -pin_load 10 [get_ports { S2 } ]
set_load -pin_load 10 [get_ports { S3 } ]
set_load -pin_load 10 [get_ports { S4 } ]
set_load -pin_load 10 [get_ports { S5 } ]
set_load -pin_load 10 [get_ports { S6 } ]
