...
set_load -pin_load 10 [get_ports { SAIDA_DECO[0] } ]
set_load -pin_load 10 [get_ports { SAIDA_DECO[1] } ]
set_load -pin_load 10 [get_ports { SAIDA_DECO[2] } ]
set_load -pin_load 10 [get_ports { SAIDA_DECO[3] } ]
set_load -pin_load 10 [get_ports { SAIDA_DECO[4] } ]
set_load -pin_load 10 [get_ports { SAIDA_DECO[5] } ]
set_load -pin_load 10 [get_ports { SAIDA_DECO[6] } ]
set_load -pin_load 10 [get_ports { SAIDA_DECO[7] } ]
set_load -pin_load 10 [get_ports { S_Cout2[0] } ]
set_load -pin_load 10 [get_ports { S_Cout2[1] } ]
set_load -pin_load 10 [get_ports { S_Cout[0] } ]
set_load -pin_load 10 [get_ports { S_Cout[1] } ]
