...
read_verilog  flipflopd_presetclear.vo
current_design FLIPFLOPD_PRESETCLEAR
link
...
read_sdf flipflopd_presetclear_v.sdo
...
set_load -pin_load 10 [get_ports { Q } ]
set_load -pin_load 10 [get_ports { QBAR } ]
