...
read_verilog  portas_2.vo
current_design portas_2
link
...
set_load -pin_load 10 [get_ports { f_and } ]
set_load -pin_load 10 [get_ports { f_nand } ]
set_load -pin_load 10 [get_ports { f_or } ]
set_load -pin_load 10 [get_ports { f_xnor } ]
