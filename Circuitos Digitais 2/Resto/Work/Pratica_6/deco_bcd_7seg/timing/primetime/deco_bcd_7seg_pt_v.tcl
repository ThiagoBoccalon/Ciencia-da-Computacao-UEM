...
read_verilog  deco_bcd_7seg.vo
current_design deco_bcd_7seg
link
...
set_load -pin_load 10 [get_ports { segmentos[0] } ]
set_load -pin_load 10 [get_ports { segmentos[1] } ]
set_load -pin_load 10 [get_ports { segmentos[2] } ]
set_load -pin_load 10 [get_ports { segmentos[3] } ]
set_load -pin_load 10 [get_ports { segmentos[4] } ]
set_load -pin_load 10 [get_ports { segmentos[5] } ]
set_load -pin_load 10 [get_ports { segmentos[6] } ]
