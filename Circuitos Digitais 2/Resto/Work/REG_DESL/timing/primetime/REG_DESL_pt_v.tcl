...
read_verilog  REG_DESL.vo
current_design REG_DESL
link
...
set_load -pin_load 10 [get_ports { SHIFTOUT[0] } ]
set_load -pin_load 10 [get_ports { SHIFTOUT[1] } ]
set_load -pin_load 10 [get_ports { SHIFTOUT[2] } ]
set_load -pin_load 10 [get_ports { SHIFTOUT[3] } ]
