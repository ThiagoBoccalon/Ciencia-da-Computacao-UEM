...
read_verilog  Exercicio_1_Estrutural.vo
current_design Exercicio_1_Estrutural
link
...
read_sdf Exercicio_1_Estrutural_v.sdo
...
set_load -pin_load 10 [get_ports { Sas } ]
set_load -pin_load 10 [get_ports { Sre } ]
set_load -pin_load 10 [get_ports { Sse } ]
set_load -pin_load 10 [get_ports { Svr } ]
