...
read_verilog  Exercicio_1.vo
current_design Exercicio_1
link
...
set_load -pin_load 10 [get_ports { S_Assessor } ]
set_load -pin_load 10 [get_ports { S_Reitor } ]
set_load -pin_load 10 [get_ports { S_Secretaria } ]
set_load -pin_load 10 [get_ports { S_VReitor } ]
