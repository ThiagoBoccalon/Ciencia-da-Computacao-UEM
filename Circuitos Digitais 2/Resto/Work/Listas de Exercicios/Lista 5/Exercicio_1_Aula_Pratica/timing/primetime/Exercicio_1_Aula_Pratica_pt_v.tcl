...
read_verilog  Exercicio_1_Aula_Pratica.vo
current_design Exercicio_1_Aula_Pratica
link
...
read_sdf Exercicio_1_Aula_Pratica_v.sdo
...
set_load -pin_load 10 [get_ports { S_Cham[0] } ]
set_load -pin_load 10 [get_ports { S_Cham[1] } ]
set_load -pin_load 10 [get_ports { S_Cham[2] } ]
set_load -pin_load 10 [get_ports { S_Cham[3] } ]
