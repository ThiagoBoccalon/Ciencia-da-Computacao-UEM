...
read_verilog  DECODIFICADOR_3x8.vo
current_design DECODIFICADOR_3x8
link
...
read_sdf DECODIFICADOR_3x8_v.sdo
...
set_load -pin_load 10 [get_ports { S[2] } ]
set_load -pin_load 10 [get_ports { S[3] } ]
set_load -pin_load 10 [get_ports { S[4] } ]
set_load -pin_load 10 [get_ports { S[5] } ]
set_load -pin_load 10 [get_ports { S[6] } ]
set_load -pin_load 10 [get_ports { S[7] } ]
