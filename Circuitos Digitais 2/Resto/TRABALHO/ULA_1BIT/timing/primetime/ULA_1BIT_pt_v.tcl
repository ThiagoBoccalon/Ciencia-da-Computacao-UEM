...
read_verilog  ULA_1BIT.vo
current_design ULA_1BIT
link
...
set_load -pin_load 10 [get_ports { SAIDA_ULA } ]
set_load -pin_load 10 [get_ports { S_Cout0 } ]
set_load -pin_load 10 [get_ports { S_Cout1 } ]
