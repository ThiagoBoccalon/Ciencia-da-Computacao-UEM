...
def recebePonto(): # calcula P1,P2,P3
    P = []
    entrada = int(input('digite a distância em x'))
    P.append(entrada)
    entrada = int(input('digite a distância em y'))
...
def recebeNV(): # Recebe numero de vertices
    NV = int(input('digite o numero de vertices do objeto'))
    return NV

def recebeCoordenadas(NV): #cria uma lista com "NV" tuplas que são as coordenadas de cada vertice
...
def recebeNumeroDeSuperficies(): # recebe numero de superficies
...
P1 = recebePonto() #P1 = (X1,Y1,Z1)
P2 = recebePonto() #P2 = (X2,Y2,Z2)
P3 = recebePonto() #P3 = (X3,Y3,Z3)
NV = recebeNV()
